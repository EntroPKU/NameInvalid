...
-> xsc::common_cpp::properties {
	auto props = xsc::common_cpp::properties();
	props.addString   ( "PARAM_FILE", "/home/siyuangao/CCF2023-NameInvalid/build.xilinx_vck5000_gen4x8_xdma_2_202210_1.hw/work/noc/xnwOut/xnwOut__snoc__registers__out.txt" );
	props.addString   ( "DEVICE_FILE"  , "/tools/Xilinx/new/Vivado/2022.2/data/parts/xilinx/devint/vault/versal/data/device_misc/xcvc1902/xcvc1902.nocme.v10.model" );
	props.addString   ( "ADDRMAP_FILE" , "/tools/Xilinx/new/Vivado/2022.2/data/parts/xilinx/common/addressing/Versal_Address_Map.xml" );
	return props;
}();
